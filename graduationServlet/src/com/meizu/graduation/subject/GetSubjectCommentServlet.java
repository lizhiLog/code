...
@WebServlet("/GetSubjectCommentServlet")
public class GetSubjectCommentServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       

    public GetSubjectCommentServlet() {
        super();
    }
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if (code == 36) {
			...
			String resultJson = dbHelper.doGetSubjectComment(id);
