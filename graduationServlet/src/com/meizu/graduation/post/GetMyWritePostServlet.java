...
@WebServlet("/GetMyWritePostServlet")
public class GetMyWritePostServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    
    public GetMyWritePostServlet() {
        super();
    }
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if (code == 64) {
			...
			String resultJson = dbHelper.doGetMyWritePost(id);
