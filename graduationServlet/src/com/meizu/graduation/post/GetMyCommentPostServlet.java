...
@WebServlet("/GetMyCommentPostServlet")
public class GetMyCommentPostServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    public GetMyCommentPostServlet() {
        super();
    }
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if (code == 62) {
			...
			String resultJson = dbHelper.doGetMyCommentPost(id);
