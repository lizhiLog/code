...
public class StudentSubjectResourceActivity extends FragmentActivity implements View.OnClickListener {
    ...
    class MyFragmentPagerAdapter extends FragmentPagerAdapter {
        ...
        StudentVideoFragment mVideoFragment;
        StudentDocumentFragment mDocumentFragment;
        StudentCourseWareFragment mCourseWareFragment;
        StudentExcelFragment mExcelFragment;

        public MyFragmentPagerAdapter(FragmentManager fm) {
            super(fm);
            mVideoFragment=new StudentVideoFragment();
            mDocumentFragment=new StudentDocumentFragment();
            mCourseWareFragment=new StudentCourseWareFragment();
            mExcelFragment=new StudentExcelFragment();
        }
