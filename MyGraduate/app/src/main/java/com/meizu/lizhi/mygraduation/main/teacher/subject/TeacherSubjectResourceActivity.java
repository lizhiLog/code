...
public class TeacherSubjectResourceActivity extends FragmentActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_teacher_subject_resource);
        initView();
    ...
    class MyFragmentPagerAdapter extends FragmentPagerAdapter {
        ...
        TeacherVideoFragment mVideoFragment;
        TeacherDocumentFragment mDocumentFragment;
        TeacherCourseWareFragment mCourseWareFragment;
        TeacherExcelFragment mExcelFragment;

        public MyFragmentPagerAdapter(FragmentManager fm) {
            super(fm);
            mVideoFragment=new TeacherVideoFragment();
            mDocumentFragment=new TeacherDocumentFragment();
            mCourseWareFragment=new TeacherCourseWareFragment();
            mExcelFragment=new TeacherExcelFragment();
        }
