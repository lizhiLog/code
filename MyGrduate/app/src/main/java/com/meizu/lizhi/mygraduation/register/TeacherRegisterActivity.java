...
public class TeacherRegisterActivity extends Activity implements View.OnClickListener {
    ...
    void initView() {
        ...
        mEditTextNo = (EditText) findViewById(R.id.userNo);
    ...
    Handler mHandler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                case SUCCESS: {
                    Toast.makeText(TeacherRegisterActivity.this, "注册失败", Toast.LENGTH_SHORT).show();
                }
            }
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.register: {
                ...
                String json = putJson();
                Log.e("", json);
                Toast.makeText(TeacherRegisterActivity.this, json, Toast.LENGTH_SHORT).show();
    ...
    class RegisterThread extends Thread {
        ...
        public void run() {
            ...
            HttpPost post = new HttpPost("http://" + StaticIp.IP + ":8080/firstApp/teacherRegisterServlet");
    ...
    boolean checkInfo() {
        ...
        userNo = mEditTextNo.getText().toString().trim();
        ...
        if (userNo.length() < 5 || userNo.length() > 12) {
            Toast.makeText(TeacherRegisterActivity.this, "资格编号不服和条件", Toast.LENGTH_SHORT).show();
            return false;
        } else if (userName.length() < 2 || userName.length() > 4) {
            Toast.makeText(TeacherRegisterActivity.this, "用户名在2～4个字符之间", Toast.LENGTH_SHORT).show();
            return false;
        } else if (checkEmail(email) == false) {
            Toast.makeText(TeacherRegisterActivity.this, "邮箱不符合条件", Toast.LENGTH_SHORT).show();
            return false;
        } else if (!password.equals(passwordSubmit) || password.length() < 5 || password.length() > 16) {
            Toast.makeText(TeacherRegisterActivity.this, "密码在5～16个字符之间", Toast.LENGTH_SHORT).show();
            return false;
        }
        return true;
    }
